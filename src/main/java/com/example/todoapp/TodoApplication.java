...
import org.springframework.boot.SpringApplication; // Spring Boot（スプリングブート）を使うための道具
import org.springframework.boot.autoconfigure.SpringBootApplication; // 自動で設定してくれる便利な道具を使う
